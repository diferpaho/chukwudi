...
const Login = () => {
    ...
    return (
        ...
        <div className="h-full bg-orange-50 w-full px-4 pb-7">
            ...
            <div className="flex flex-col items-center justify-center">
                ...
                <div className="bg-white shadow rounded lg:w-1/3  md:w-1/2 w-full p-10 mt-16">
                    ...
                    <p tabIndex={0} className="focus:outline-none text-sm mt-4 font-medium leading-none text-gray-500">Dont have account? <Link href="/register" >Sign up here</Link></p>
