        ...
        <>
            ...
            <div id="main" className="container mx-auto grid grid-cols-3">
                <div className="1 col-span-3 lg:col-span-2  grid grid-cols-9">
                    ...
                    {products.map((item) => (
                        <div key={item.id} className="col-span-9 md:col-span-3 mx-3 mt-10">
                            <div className="max-w-xs rounded-2xl overflow-hidden shadow-lg my-2 hover:scale-110">
                                ...
                                <div className="px-6 py-4">
                                    ...
                                    <p className=" text-center mt-3">
                                        <button onClick={() => addProduct(item.id, item.name, item.price, item.image)}
                                            className="text-sm ml-5 bg-yellow-400 text-white mx-auto  p-1 px-6 rounded font-bold overflow-hidden hover:scale-150">Add</button>
                ...
                <div className="2 col-span-3 lg:col-span-1  border-l">
                    ...
                    <div className="grid grid-cols-3 mt-10 mx-16 p-5 border-b-2 bg-yellow-400 rounded-3xl hover:scale-110">
